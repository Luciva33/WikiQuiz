...
answers = [ # 回答一覧
    ...
    '田町駅','浜松町駅','新橋駅','有楽町駅'],
    ['徳川家康','徳川家光','徳川綱吉','徳川吉宗','徳川慶喜','松平定信','田沼意次','井伊直弼','安藤信正','阿部正弘'],
    ['秋元才加','板野友美','大島優子','小野恵令奈','河西智美','柏木由紀','北原里英','小嶋陽菜','指原莉乃','佐藤亜美菜',
     '篠田麻里子','高城亜樹','高橋みなみ','仲川遥香','前田敦子','松井珠理奈','松井玲奈','峯岸みなみ','宮崎美穂','宮澤佐江','渡辺麻友'],
...
cate = [
    '山手線の駅','江戸時代の人物','AKB48「ヘビーローテーション」の選抜メンバー','2023年家庭用ゲームソフト販売本数TOP10','2023年Spotify Japanで最も再生されたアーティストTOP10',
